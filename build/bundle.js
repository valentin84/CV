var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c() {
    			...
    			t0 = space();
    			h1 = element("h1");
    			h1.textContent = "Valentin Ciobanu";
    			t2 = space();
    			span0 = element("span");
    			span0.textContent = "Front-end Developer";
    			t4 = space();
    			span1 = element("span");
    			span1.textContent = "Bucharest, Romania";
    			t6 = space();
    			span2 = element("span");
    			span2.textContent = "+(40)771.280.800";
    			t8 = space();
    			span3 = element("span");
    			span3.textContent = "valentin.ciobanu(at)ciolentin.ro";
    ...
    /* src\Profile.svelte generated by Svelte v3.37.0 */
    ...
    // (46:4) {#each info as data}
    function create_each_block$1(ctx) {
    	let p;
    	let t_value = /*data*/ ctx[4].description + "";
    	let t;
    	let p_intro;
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*info*/ 4 && t_value !== (t_value = /*data*/ ctx[4].description + "")) set_data(t, t_value);
    		},
    		i(local) {
    			if (!p_intro) {
    				add_render_callback(() => {
    ...
    function typewriter$2(node, { speed = 30 }) {
    ...
    class Profile extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$2, create_fragment$3, safe_not_equal, { name: 1, expanded: 0 });
    	}
    }

    /* src\Employment.svelte generated by Svelte v3.37.0 */

    function get_each_context(ctx, list, i) {
    	const child_ctx = ctx.slice();
    	child_ctx[5] = list[i].job_title;
    	child_ctx[6] = list[i].company_name;
    	child_ctx[7] = list[i].city_name;
    	child_ctx[8] = list[i].employment_period;
    	child_ctx[9] = list[i].task;
    	return child_ctx;
    }
    ...
    function create_each_block_1(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*data*/ 4 && t_value !== (t_value = /*item*/ ctx[12] + "")) set_data(t, t_value);
    		},
    		i(local) {
    			if (!li_intro) {
    				add_render_callback(() => {
    					li_intro = create_in_transition(li, typewriter$1, {});
    					li_intro.start();
    				});
    			}
    		},
    ...
    // (49:4) {#each data as {job_title, company_name, city_name, employment_period, task}}
    function create_each_block(ctx) {
    	let div;
    	let h3;
    	let t0_value = /*job_title*/ ctx[5] + "";
    	let t0;
    	let t1;
    	let t2_value = /*company_name*/ ctx[6] + "";
    	let t2;
    	let t3;
    	let t4_value = /*city_name*/ ctx[7] + "";
    	let t4;
    	let t5;
    	let span;
    	let t6_value = /*employment_period*/ ctx[8] + "";
    	let t6;
    	let span_intro;
    	let t7;
    	let p;
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*data*/ 4 && t0_value !== (t0_value = /*job_title*/ ctx[5] + "")) set_data(t0, t0_value);
    			if (dirty & /*data*/ 4 && t2_value !== (t2_value = /*company_name*/ ctx[6] + "")) set_data(t2, t2_value);
    			if (dirty & /*data*/ 4 && t4_value !== (t4_value = /*city_name*/ ctx[7] + "")) set_data(t4, t4_value);
    			if (dirty & /*data*/ 4 && t6_value !== (t6_value = /*employment_period*/ ctx[8] + "")) set_data(t6, t6_value);

    			if (dirty & /*data*/ 4) {
    				each_value_1 = /*task*/ ctx[9];
    				let i;
    ...
    function typewriter$1(node, { speed = 30 }) {
    	const valid = node.childNodes.length === 1 && node.childNodes[0].nodeType === Node.TEXT_NODE;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [expanded, name, data, toggle];
    }

    class Employment extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$1, create_fragment$2, safe_not_equal, { name: 1, expanded: 0 });
    	}
    }

    /* src\Education.svelte generated by Svelte v3.37.0 */
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			h3 = element("h3");
    			h3.textContent = "Facultatea de Sociologie, Universitatea Bucuresti";
    			t1 = space();
    			span = element("span");
    			span.textContent = "2009-2011";
    			attr(div, "class", "profile");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    ...
    function create_fragment$1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*expanded*/ ctx[0] && create_if_block();
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(h2, "click", /*toggle*/ ctx[2]);
    				mounted = true;
    			}
    		},
    		p(ctx, [dirty]) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [expanded, name, toggle];
    }

    class Education extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance, create_fragment$1, safe_not_equal, { name: 1, expanded: 0 });
    	}
    }
